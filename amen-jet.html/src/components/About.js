  ...
  return (
    <div id="about" className='md:text-left bg-primary2 py-10 md:py-20 text-white'>
      <div className='gap-10 w-11/12 mx-auto flex justify-around'>
        ...
        <div className='hidden w-1/2 md:flex flex-col max-h-min'>
          <img src='/assets/about.jpeg' alt="illustration" className='self-center w-4/5 h-96 object-cover rounded-3xl' />
        </div>
