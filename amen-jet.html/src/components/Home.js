...
function Home() {
  ...
  return (
    <div className="relative bg-slate-900">
      ...
      <div className="z-20 relative flex flex-col justify-center w-10/12 mx-auto p-20 space-y-5 text-white h-[550px] ">
        <p className='bg-[#041C3780]  self-center block px-2 py-1 border-l-4 border-primary1'>Amen Jet Medical Services</p>
        <h5 className="font-rubik text-7xl font-bold leading-[71.1px]">{quotes[currentCount]} </h5>
