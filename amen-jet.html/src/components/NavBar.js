...
function NavBar() {
  ...
  return (
    <div
      className="sticky top-0 left-0  border-b flex z-30 justify-between backdrop-blur md:px-20 bg-white"
    >
      ...
      <div>
        ...
        >
          <div className=" my-5 ">
            <div className="flex justify-between sticky top-4 backdrop-blur">
              ...
              <button
                className="mr-5 self-center bg-white text-primary2 rounded-full w-16 h-16"
                onClick={() => toggleSideBar()}
              >
                {close}
              </button>
